...
void GameMgr::LoadLevel() {
	engine->gfxMgr->mSceneMgr->setAmbientLight(
			Ogre::ColourValue(0.35, 0.35, 0.35));
	...
	Ogre::MeshManager::getSingleton().createPlane("ground",
			...
			100000, 100000, 10, 10, true, 1, 4000, 4000, Ogre::Vector3::UNIT_Z);
	Ogre::Entity *groundEntity = engine->gfxMgr->mSceneMgr->createEntity(
			"ground");
	...
	MainPlayer =
			static_cast<Player*>(engine->entityMgr->CreateEntityOfTypeAtPosition(
